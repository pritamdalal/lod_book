...
This book would not have been possible without the support of by data partner: [Delta Neutral](http://www.historicaloptiondata.com).  When I was asked to teach a finacial data analysis course at the University of Minnesota, I knew I wanted a real-world data set to be the center-piece.  A few years ago, I had purchased a years worth of Delta Neutral's files to complete a backtest that I was working on.  I was immeasurably impressed with the data, especially when compared to that of their competators, both in terms of price and quality.  


Delta Neutral was founded in 2002 by [Rick Fortier](https://www.linkedin.com/in/rick-fortier-53061a7/); at the time he was looking for high quality daily option data, and there simply were no reasonable sources.  Options data is complex. Rick and his team have hit a homerun with their product.  When I approached Rick about showcasing his data in my courses, he was excited to help spread knowledge of options and data analysis through this innovative channel. 

Nearly all the data analysis examples in this book come from the Level 3 data.  This is a phenominal data set of the highest quality that contains daily prices for all options traded on thousands of equity underlyings.  The full data set dates back to 2002.  Feel free to reach out me, or to the founder of Delta Netural, if you have further questions about their data offerings: rick@deltaneutral.com.
...
Due to a scheduling conflict this initial vision had to be modified.  Instead I would be teaching similar material, but at a more introductory level to the first year students. The typical first year MFM student math majors with minimial previous exposure to options or programming.  So generally very smart students with a solid educational foundation, but with little in the way of directly applicabile knowlege to the task of backtesting options.   

As I pondered the task, it occured to me that I was going to have to present both the basic definition of an option as well as the basic definition of a for-loop.  To guide students from that point, to the point of being able to backt trading strategies seemed like an impossibly tall order. But I was intrigued by the challenge and so I accepted.
...
The math prerequisite to mastering options are is strong intuitive understanding of calculus, linear algebra, probablility, and statistics.  In reality, this probably comes from a 3-semester calculus sequece, and semester long undergraduate courses in the other three areas.  The options self-help community would probaby argue that you don't need that much math, but I disagree.  There are certainly diminishing practical returns to advanced subjects like stochastic calculus and functional analysis, but the areas I detail above are a far cry from that. 
...
This book is designed for learning both data analysis and finance.  

This book is a hybrid of an introductory data analysis text and an introductory options text.  It's a jack of two trades, and master of neither.  LOD is designed to be a companion to books detailed below. Throughout the I will assign readings from these other books, both for the purposes of addressing basics that have already been exposited well elsewhere, or for a deeper dive into material for those who want to know more.  These additional readings aren't strictly necessary, but will lead to deeper understanding.
...
I have a huge amount of affection for Hadley Wickham's **R for Data Science** and similar titles.  So much so that this book was written in it's image.  So much so that this morning I spent 20 minutes figuring how to get my welcome pageto look the exactly like his - yeah I know, I've got issues.

Such general coding books, by their very nature, cannot be context specific.  But ultimately, creating visulizations of data relating to cars or flights often left me feeling empty and a bit drowsy.   The truth is that it's always more enjoyable and effective learn data analysis when you care about the data.  That's really the thrust of this book - learning data analysis in the context of options.

#### Type Along {-}

Pen and paper is dead.  If you're not typing code and watching output come out, you're not really learning.  The interactive coding environments of R and Python are ideal for this kind of learning.  Even if you think you have no idea of what is going on, if there is coding example, force yourself to type it out (copy/paste doesn't count) and make sure you get the same output.

#### Don't Reinvent the Wheel {-}

So much for avoiding cliques.  The point is that there has been a ton of great introductory material written on both data analysis and options.  While I do present my take on some of this material, I also assign reading assignment to the texts mentioned above.


## Acknowledgments

The layout of this book was adapted from the `bookdown` files of two great books: [R Markdown: The Definitive Guide](https://bookdown.org/yihui/rmarkdown/) and [R for Data Science](https://r4ds.had.co.nz/).  Many thanks to the authors Yihui Xie, J. J. Allaire, Garrett Grolemund, and Hadley Wickham for making the files freely available on Github.
