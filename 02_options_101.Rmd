...
Notice that if the damage is less than the \$1,000 strike price, Sally receives no reimbursement from her insurance.  For every dollar over the strike price, Sally receives a one-for-one payout.  Publicly traded option contracts, which are the subject of this book, behave similarly.
...
1. Under what circumstances will Ruobing choose to exercise his right?
...
The other meaning of long/short has to do with how you depending on the direction of change of the price of an asset.
