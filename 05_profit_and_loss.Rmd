...
In words, $I_i$ is simply the initial capital, plus cummulative pnl of the portfolio up until trade date $t_{i}$,
<br>
```{exercise}
Show that:
\begin{align*}
...
Asset returns are a simpler concept, that is related to the 
