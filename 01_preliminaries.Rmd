...
Put-call parity is one of the most important and foundational results in all of derivatives theory.

### Non-Dividend Paying Stock
Recall that when the stock pays no dividends during the life of the forward, that the forward price is simply the accumulated spot price.
